...
export const Categories = () => {
  ...
  const paginatedCategories = categories.slice(startIdx, startIdx + ITEMS_PER_PAGE);
          ...
          {categories.length > ITEMS_PER_PAGE && (
            <div className="flex items-center justify-between mt-6">
              <div className="text-sm text-gray-600">
                Mostrando {startIdx + 1} a {Math.min(startIdx + ITEMS_PER_PAGE, categories.length)} de {categories.length} categorias
              </div>
